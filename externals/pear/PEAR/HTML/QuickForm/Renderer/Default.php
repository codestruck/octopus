...

{
    ...
    */
    ...
    var $_headerTemplate =
        ...
        "\n\t<tr valign=\"bottom\" class=\"qf-row qf-header-row\">\n\t\t<td class=\"qf-header\" colspan=\"2\"><b>{header}</b></td>\n\t</tr>";
    ...
    */
    ...
    var $_elementTemplate =
        ...
        "\n\t<tr class=\"qf-row{error_class}\">\n\t\t<td class=\"qf-label\"><!-- BEGIN required --><span class=\"qf-required\">* </span><!-- END required -->&nbsp;{label}</td>\n\t\t<td class=\"qf-field\"><!-- BEGIN error --><span class=\"qf-error\">{error}</span><br /><!-- END error -->\t{element}</td>\n\t</tr>";
    ...
    */
    ...
    var $_formTemplate =
        ...
        "\n<form{attributes}>\n<div>\n{hidden}<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"qf-table\">\n{content}\n</table>\n</div>\n</form>";
    ...
    */
    ...
    var $_requiredNoteTemplate =
        ...
        "\n\t<tr class=\"qf-row qf-required-row\">\n\t\t<td colspan=\"2\">{requiredNote}</td>\n\t</tr>";
    ...
    */
...

    {
        ...
        if (isset($error)) {
			...
			$html = str_replace('{error_class}', ' qf-row-error', $html);  // MB: Allow the whole row to have an error class
			...
			$html = str_replace('{error_class}', '', $html);  // MB: Cleanup hook
