...
class Octopus_Image_Mode_Crop extends Octopus_Image_Mode_Base {

    function Octopus_Image_Mode_Crop($src, $layout) {
        $this->src = $src;
        $this->layout = $layout;
    }
    ...
    function prepare() {
        ...
        // Do the ratio work
        $ratio = max($this->layout->width/$this->src->width, $this->layout->height/$this->src->height);
